# BRIEF — Kanebreak Custom Backyards (decks, fencing & outdoor living)

## Client facts (REAL, verified)
- Business: Kanebreak Custom Backyards
- Phone: (864) 884-4605 — tel: href MUST be `+18648844605` (E.164, 12 chars, NO double-1)
- City / service area: Greenville / Simpsonville, SC
- Owner: TBD
- Services (use EXACTLY these): Custom Decks, Fencing, Patios, Outdoor Living
- Tagline direction: "Custom backyards, built to last" (keep it human, no AI-speak)
