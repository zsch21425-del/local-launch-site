# BRIEF — All In One Maintenance (junk removal / lawn / handyman)

## Client facts (REAL, verified)
- Business: All In One Maintenance
- Phone: (864) 658-7960 — tel: href MUST be `+18646587960` (E.164, 12 chars, NO double-1)
- City / service area: Pelzer, SC
- Owner: TBD
- Services (use EXACTLY these): Junk Removal, Grass Cutting, Handyman Repairs, Hauling
- Tagline direction: "One call for junk, lawn & repairs" (keep it human, no AI-speak)
