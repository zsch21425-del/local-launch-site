# Builder Task — Sasquatch Tree Services LLC (tree-service premium rebrand)

You are in `/mnt/d/LocalLaunch/builder-work/sasquatch-tree-services`. This is a fork of the CANONICAL tree-service premium template (OKLCH + video hero + trust marquee + sticky HD bg + frosted-glass cards + gallery + testimonials + service area + contact + Local Launch footer). Rebrand it into **Sasquatch Tree Services LLC**, a tree service in Spartanburg, SC.

## REAL FACTS (verified)
- Business: Sasquatch Tree Services LLC
- City: Spartanburg, SC (serve "Spartanburg & the Upstate")
- Phone: (864) 497-8082 · tel:+118644978082
- Email: sasquatchtreeservices@gmail.com
...
## WHAT TO CHANGE
1. Replace ALL "Lumberjack Tree Service" → "Sasquatch Tree Services LLC"
2. Remove owner name "Christopher McCollum" → use generic "our crew" / no named owner
3. Replace phone "864-642-7705" → "(864) 497-8082" (display text AND every tel: link)
4. City/area: "Anderson, SC" → "Spartanburg, SC" (and any other area mentions)
5. Services (4 cards), match text + keep tree icons:
- Hazardous Removal
- Spikeless Pruning
- Storm Damage
- Stump Grinding
6. Trust marquee → ONLY verified items (replace "12 Years · 24/7 Emergency · Free Estimates · Veteran & Senior Discounts · Residential & Commercial"): use "Hazardous Removal · Spikeless Pruning · Storm Damage" and "Serving Spartanburg & the Upstate". REMOVE all unverified claims ("12 Years", "24/7 Emergency", "Free Estimates", "Veteran & Senior Discounts", "licensed & insured").
7. REVIEWS — NO verified review count or verbatim quotes exist for this business. REPLACE the testimonial/review section, the "Ken Lovingood" quote, and the "Google 5.0★ (5 reviews)" / "Facebook 100% recommend (13 reviews)" stats with an HONEST line: "Trusted by homeowners across Spartanburg & the Upstate." Do NOT fabricate any star count, review count, or quote.
