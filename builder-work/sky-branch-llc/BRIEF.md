# BRIEF — Sky Branch LLC (gutter cleaning & window replacement)

## Client facts (REAL, verified)
- Business: Sky Branch LLC
- Phone: (864) 621-0858 — tel: href MUST be `+18646210858` (E.164, 12 chars, NO double-1)
- City / service area: Greer, SC
- Owner: TBD
- Services (use EXACTLY these): Gutter Cleaning, Gutter Repair, Window Replacement, Downspout Service
- Tagline direction: "Greer's gutter & window experts" (keep it human, no AI-speak)
...
## Build instructions
- Fork the `gutter-cleaning` template ALREADY COPIED into this directory (index.html + assets). Do NOT redesign sections — rebrand only.
