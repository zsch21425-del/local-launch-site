# BRIEF — Fresh Start Pressure Washing (pressure washing)

## Client facts (REAL, verified)
- Business: Fresh Start Pressure Washing
- Phone: (864) 633-7810 — tel: href MUST be `+18646337810` (E.164, 12 chars, NO double-1)
- City / service area: Clemson, SC
- Owner: TBD
- Services (use EXACTLY these): House Washing, Driveway Cleaning, Soft Washing, Deck Washing
- Tagline direction: "Clemson pressure washing, fresh start" (keep it human, no AI-speak)
