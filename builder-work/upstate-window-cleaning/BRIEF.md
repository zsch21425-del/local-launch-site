# BRIEF — Upstate Window Cleaning LLC (window & gutter cleaning)

## Client facts (REAL, verified)
- Business: Upstate Window Cleaning LLC
- Phone: (864) 398-0766 — tel: href MUST be `+18643980766` (E.164, 12 chars, NO double-1)
- City / service area: Inman, SC
- Owner: TBD
- Services (use EXACTLY these): Window Cleaning, Gutter Cleaning, Screen Repair, Pressure Washing
- Tagline direction: "Inman's window & gutter specialists" (keep it human, no AI-speak)
