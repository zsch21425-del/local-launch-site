# Builder Task — Rig Line Tree Service (tree-service premium rebrand)

You are in `/mnt/d/LocalLaunch/builder-work/rig-line-tree-service`. This is a fork of the CANONICAL tree-service premium template (OKLCH + video hero + trust marquee + sticky HD bg + frosted-glass cards + gallery + testimonials + service area + contact + Local Launch footer). Rebrand it into **Rig Line Tree Service**, a tree service in Westminster, SC.

## REAL FACTS (verified)
- Business: Rig Line Tree Service
- City: Westminster, SC (serve "Westminster & the Upstate")
- Phone: (864) 247-9107 · tel:+118642479107
- Email: Riglinetreeservice@yahoo.com
...
## WHAT TO CHANGE
1. Replace ALL "Lumberjack Tree Service" → "Rig Line Tree Service"
2. Remove owner name "Christopher McCollum" → use generic "our crew" / no named owner
3. Replace phone "864-642-7705" → "(864) 247-9107" (display text AND every tel: link)
4. City/area: "Anderson, SC" → "Westminster, SC" (and any other area mentions)
5. Services (4 cards), match text + keep tree icons:
- Tree Removal
- Tree Thinning
- Tree Pruning
- Stump Grinding
6. Trust marquee → ONLY verified items (replace "12 Years · 24/7 Emergency · Free Estimates · Veteran & Senior Discounts · Residential & Commercial"): use "Tree Removal · Tree Thinning · Tree Pruning" and "Serving Westminster & the Upstate". REMOVE all unverified claims ("12 Years", "24/7 Emergency", "Free Estimates", "Veteran & Senior Discounts", "licensed & insured").
7. REVIEWS — NO verified review count or verbatim quotes exist for this business. REPLACE the testimonial/review section, the "Ken Lovingood" quote, and the "Google 5.0★ (5 reviews)" / "Facebook 100% recommend (13 reviews)" stats with an HONEST line: "Trusted by homeowners across Westminster & the Upstate." Do NOT fabricate any star count, review count, or quote.
