# BRIEF — Brian Dillard Concrete LLC (concrete contractor)

## Client facts (REAL, verified)
- Business: Brian Dillard Concrete LLC
- Phone: (864) 606-2818 — tel: href MUST be `+18646062818` (E.164, 12 chars, NO double-1)
- City / service area: Roebuck, SC
- Owner: Brian Dillard
- Services (use EXACTLY these): Driveways, Patios, Foundations, Stamped Concrete
- Tagline direction: "Roebuck concrete done right" (keep it human, no AI-speak)
...
## Build instructions
- Fork the `concrete` template ALREADY COPIED into this directory (index.html + assets). Do NOT redesign sections — rebrand only.
