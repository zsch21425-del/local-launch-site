# BRIEF — Gotta Guy Home Services (handyman)

## Client facts (REAL, verified)
- Business: Gotta Guy Home Services
- Phone: (864) 430-7248 — tel: href MUST be `+18644307248` (E.164, 12 chars, NO double-1)
- City / service area: Simpsonville / Fountain Inn, SC
- Owner: TBD
- Services (use EXACTLY these): Deck Repair, Door Installation, Flooring, Light Fixtures & Gutters
- Tagline direction: "Your go-to guy for home services" (keep it human, no AI-speak)
