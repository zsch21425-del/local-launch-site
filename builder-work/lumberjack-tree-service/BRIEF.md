# BRIEF — Lumberjack Tree Service (tree service)

## Client facts (REAL, verified)
- Business: Lumberjack Tree Service
- Phone: (864) 642-7705 — tel: href MUST be `+18646427705` (E.164, 12 chars, NO double-1)
- City / service area: Anderson, SC
- Owner: Chris McCollum
- Services (use EXACTLY these): Tree Removal, Tree Trimming, Storm Cleanup, 24/7 Emergency
- Tagline direction: "Anderson's 24/7 tree service" (keep it human, no AI-speak)
...
## Build instructions
- Fork the `tree-service` template ALREADY COPIED into this directory (index.html + assets). Do NOT redesign sections — rebrand only.
