# BRIEF — BRB Pressure Washing Service (pressure washing)

## Client facts (REAL, verified)
- Business: BRB Pressure Washing Service
- Phone: (864) 630-3757 — tel: href MUST be `+18646303757` (E.164, 12 chars, NO double-1)
- City / service area: Simpsonville / Greenville, SC
- Owner: Charles A. Belin
- Services (use EXACTLY these): House Washing, Driveway Cleaning, Deck & Fence Washing, Soft Washing
- Tagline direction: "Simpsonville's pressure washing pros" (keep it human, no AI-speak)
...
- Visualizer: YES — this trade REQUIRES a before/after visualizer slider. Include it.

## Build instructions
- Fork the `pressure-washing` template ALREADY COPIED into this directory (index.html + assets). Do NOT redesign sections — rebrand only.
