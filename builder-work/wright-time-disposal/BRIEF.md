# BRIEF — Wright Time Disposal Service (junk removal)

## Client facts (REAL, verified)
- Business: Wright Time Disposal Service
- Phone: (864) 376-1200 — tel: href MUST be `+18643761200` (E.164, 12 chars, NO double-1)
- City / service area: Pelzer, SC
- Owner: TBD
- Services (use EXACTLY these): Junk Removal, Debris Hauling, Appliance Removal, Cleanouts
- Tagline direction: "Pelzer junk removal, right on time" (keep it human, no AI-speak)
...
## Build instructions
- Fork the `junk-removal` template ALREADY COPIED into this directory (index.html + assets). Do NOT redesign sections — rebrand only.
