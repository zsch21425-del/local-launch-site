# BRIEF — SBC Handyman Services (handyman)

## Client facts (REAL, verified)
- Business: SBC Handyman Services
- Phone: (864) 920-9626 — tel: href MUST be `+18649209626` (E.164, 12 chars, NO double-1)
- City / service area: Greenville, SC
- Owner: TBD
- Services (use EXACTLY these): Appliance Repair, Drywall, Light Fixtures, Home Repairs
- Tagline direction: "Greenville handyman you can count on" (keep it human, no AI-speak)
