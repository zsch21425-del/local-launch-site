# BRIEF — Milford Mountain Landscape (landscaping)

## Client facts (REAL, verified)
- Business: Milford Mountain Landscape
- Phone: (864) 416-1596 — tel: href MUST be `+18644161596` (E.164, 12 chars, NO double-1)
- City / service area: Greer, SC
- Owner: TBD
- Services (use EXACTLY these): Landscape Design, Planting, Mulching, Stone Work & Window Boxes
- Tagline direction: "Greer landscape design & care" (keep it human, no AI-speak)
...
## Build instructions
- Fork the `lawncare` template ALREADY COPIED into this directory (index.html + assets). Do NOT redesign sections — rebrand only.
