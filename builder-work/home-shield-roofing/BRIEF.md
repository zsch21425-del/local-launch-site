# BRIEF — Home Shield Roofing (residential roofing)

## Client facts (REAL, verified)
- Business: Home Shield Roofing
- Phone: (864) 209-6219 — tel: href MUST be `+18642096219` (E.164, 12 chars, NO double-1)
- City / service area: Anderson, SC
- Owner: TBD
- Services (use EXACTLY these): Roof Repair, Roof Replacement, Leak Repair, Inspections
- Tagline direction: "Anderson's roofing shield" (keep it human, no AI-speak)
...
## Build instructions
- Fork the `roofing` template ALREADY COPIED into this directory (index.html + assets). Do NOT redesign sections — rebrand only.
