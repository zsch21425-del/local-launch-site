# BRIEF — Tree Wisemen Upstate (tree service)

## Client facts (REAL, verified)
- Business: Tree Wisemen Upstate
- Phone: (415) 850-7584 — tel: href MUST be `+14158507584` (E.164, 12 chars, NO double-1)
- City / service area: Easley, SC
- Owner: TBD
- Services (use EXACTLY these): Tree Removal, Tree Trimming & Pruning, Stump Grinding, Emergency Storm Cleanup
- Tagline direction: "Easley's tree care professionals" (keep it human, no AI-speak)
