# BRIEF — Fresh Blades Lawn Care (lawn care)

## Client facts (REAL, verified)
- Business: Fresh Blades Lawn Care
- Phone: (864) 304-5845 — tel: href MUST be `+18643045845` (E.164, 12 chars, NO double-1)
- City / service area: Lyman, SC
- Owner: TBD
- Services (use EXACTLY these): Lawn Mowing, Edging, Leaf Cleanup, Lawn Maintenance
- Tagline direction: "Lyman lawn care, fresh every time" (keep it human, no AI-speak)
