# BRIEF — Gulotta's Window Cleaning (window cleaning, pressure washing, gutters)

## Client facts (REAL, verified)
- Business: Gulotta's Window Cleaning
- Phone: (864) 934-9526 — tel: href MUST be `+18649349526` (E.164, 12 chars, NO double-1)
- City / service area: Greenville, SC
- Owner: Jeff & Cathy Gulotta
- Services (use EXACTLY these): Window Cleaning, Pressure Washing, Gutter Cleaning, Screen Cleaning
- Tagline direction: "Greenville's trusted window & exterior cleaning" (keep it human, no AI-speak)
