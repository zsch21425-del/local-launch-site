...
SAMPLE_URL = os.environ.get(
    "VISUALIZER_SAMPLE",
    "https://bm-pressure-washing-demo.vercel.app/driveway-before-real.jpg",
)

INSTRUCTION = (
    "Show this home protected by professional pest control treatment: a technician "
    "in uniform applying a safe perimeter treatment around the foundation and yard, "
    "mosquito fogging in the bushes, and a spotless, pest-free lawn. Keep the exact "
    "same angle, composition, house, lawn, and lighting as the source photo. Only "
    "add the professional pest-control treatment and make the property look clean, "
    "protected, and worry-free. Photorealistic."
)
